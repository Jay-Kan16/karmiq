export type Role="customer"|"worker"|"admin"; export type BookingStatus="SEARCHING"|"REQUESTED"|"MATCHING"|"WORKER_ASSIGNED"|"ACCEPTED"|"ON_THE_WAY"|"ARRIVED"|"SERVICE_STARTED"|"COMPLETED"|"CANCELLED"|"PAYMENT"|"RATING"|"REJECTED"; export type PaymentStatus="PENDING"|"PAID"|"FAILED"; export type Availability="online"|"offline"|"busy";
